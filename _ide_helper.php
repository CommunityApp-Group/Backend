 ...
 */
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Auth\Passwords\PasswordBrokerManager         
                        /** @var \App\Repositories\Password\CustomPasswordBrokerManager $instance */
     ...
     */ 
         ...
         * 
         *
         * @see \App\Macros\ResponseMacro::success()
         * @param mixed $message
         * @param mixed $data
         * @param mixed $status
         * @static 
         ...
         * 
         *
         * @see \App\Macros\ResponseMacro::errorResponse()
         * @param mixed $message
         * @param mixed $data
         * @param mixed $status
         * @static 
         */ 
        public static function errorResponse($message, $data = [], $status = 400)
        {
                        return \Illuminate\Routing\ResponseFactory::errorResponse($message, $data, $status);
        }
